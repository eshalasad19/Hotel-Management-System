...
const CheckinCheckout = () => {
  ...
  // CHECK-OUT LIST
  const checkOutList = bookings.filter(
  ...
  const BookingRow = ({ b, showCheckout = false }) => {
    ...
    return (
      <tr className={isOverdue ? "table-danger" : ""}>
        ...
        <td>
          <span className={showCheckout ? "" : "text-success fw-medium"}>
            {checkIn}
          </span>
        </td>

        <td>
          <span className={showCheckout ? "text-warning fw-medium" : ""}>
            {checkOut}
          </span>
        </td>
          ...
          {activeTab === "checkin" && (
            <>
              <p className="text-muted mb-3">
                ...
                Guests whose check-in date is <strong>today</strong>.
              </p>
            ...
            <div className="modal-content">
              <div className="modal-header bg-warning-subtle">
                <h5 className="modal-title">
                  <i className="ri-logout-box-line me-2 text-warning"></i>
                  Confirm Check-out
                </h5>
              ...
              <div className="modal-body">
                    ...
                    <div className="col-6">
                      ...
                      <h6>
                        {selectedBooking.roomId
                          ? `Room ${selectedBooking.roomId.roomNumber}`
                          : "—"}
                      </h6>
                    </div>

                    <div className="col-6">
                      <p className="text-muted mb-1 fs-12">Amount</p>
                ...
                <div className="alert alert-warning">
                  ...
                  Room will be automatically marked as{" "}
                  <strong>Available</strong> after check-out.
                </div>
              </div>
