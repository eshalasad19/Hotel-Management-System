...
const map = {
  ...
  const typeBadge = (type) => {
    ...
    return (
      <span className={`badge ${map[type] || "bg-secondary"}`}>{type}</span>
    );
  };
...
const handleDelete = async () => {
  ...
  try {
    ...
    await axios.delete(
      `${API_URL}/rooms/${selectedRoom._id}`,
      { headers }
    );
                    ...
                    <tr key={room._id}>
                      ...
                      <td>
                        {room.images?.length > 0 ? (
                          <img
                            src={`http://localhost:5001/uploads/${room.images[0]}`}
                            alt="room"
                            width="70"
                            height="70"
                            style={{
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="input-group">
                      <span className="input-group-text">
                        {form.floor === "ground" && "GF"}

                        {form.floor === "first" && "FF"}

                        {form.floor === "second" && "SF"}
                      </span>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    <strong>Price:</strong>
                    <p>PKR {viewRoom.price}</p>
                  </div>

                  <div className="col-md-6">
                    <strong>Capacity:</strong>
                    <p>{viewRoom.capacity} Guests</p>
                  </div>
                  ...
                  <div className="col-12">
                    ...
                    <p>{viewRoom.description || "No description"}</p>
                  </div>
                </div>
              </div>
            </div>
