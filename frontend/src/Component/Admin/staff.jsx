                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Manage Staff</h4>
                                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addStaffModal">
                                    <i class="ri-user-add-line me-1"></i> Add Staff Member
                                </button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-medium text-muted mb-1 fs-12">Total Staff</p>
                                            <h4 class="mb-0 fw-semibold" id="stat-total-staff">0</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-medium text-muted mb-1 fs-12">Receptionists</p>
                                            <h4 class="mb-0 fw-semibold" id="stat-receptionist">0</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm flex-shrink-0">
                                            <span class="avatar-title bg-success-subtle rounded fs-3">
                                                <i class="bx bx-brush text-success"></i>
                                            </span>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-medium text-muted mb-1 fs-12">Housekeeping</p>
                                            <h4 class="mb-0 fw-semibold" id="stat-housekeeping">0</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-medium text-muted mb-1 fs-12">Maintenance</p>
                                            <h4 class="mb-0 fw-semibold" id="stat-maintenance">0</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            ...
                            <select class="form-select form-select-sm w-auto" id="filter-role">
                ...
                <div class="modal fade" id="addStaffModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div id="add-staff-error" class="alert alert-danger d-none"></div>
                                <div class="row g-3">
                                    <div class="col-12">
                                        <label class="form-label">Full Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="add-staffName" placeholder="Enter full name">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Email <span class="text-danger">*</span></label>
                                        <input type="email" class="form-control" id="add-staffEmail" placeholder="Enter email">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Phone <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="add-staffPhone" placeholder="e.g. 03001234567">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Role <span class="text-danger">*</span></label>
                                        <select class="form-select" id="add-staffRole">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="password" class="form-control" id="add-staffPassword" placeholder="Set password">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal fade" id="editStaffModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div id="edit-staff-error" class="alert alert-danger d-none"></div>
                                <input type="hidden" id="edit-staffId">
                                <div class="row g-3">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="edit-staffPhone">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Role</label>
                                        <select class="form-select" id="edit-staffRole">
                                            <option value="manager">Manager</option>
                                            <option value="receptionist">Receptionist</option>
                                            <option value="housekeeping">Housekeeping</option>
                                            <option value="maintenance">Maintenance</option>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                                <button type="button" class="btn btn-primary" id="editStaffBtn">Save Changes</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-body text-center p-4">
                                ...
                                <input type="hidden" id="delete-staffId">
                                <div class="d-flex gap-2 justify-content-center">
                                    <button class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                                    <button class="btn btn-danger" id="confirmDeleteStaffBtn">Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
function roleBadge(role) {
    const map = {
        ...
        manager:      '<span class="badge bg-purple-subtle text-purple">Manager</span>',
        receptionist: '<span class="badge bg-info-subtle text-info">Receptionist</span>',
        housekeeping: '<span class="badge bg-success-subtle text-success">Housekeeping</span>',
...
async function loadStaff() {
    try {
        ...
        const res = await fetch(window.API_URL + '/auth/users', {
            headers: { 'Authorization': 'Bearer ' + token }
        });
        const data = await res.json();
        // Sirf staff — guests nahi
        allStaff = data.filter(u => ['admin','manager','receptionist','housekeeping','maintenance'].includes(u.role) && u.role !== 'admin');
...
function updateStats(staff) {
    ...
    document.getElementById('stat-receptionist').textContent = staff.filter(u => u.role === 'receptionist').length;
    document.getElementById('stat-housekeeping').textContent = staff.filter(u => u.role === 'housekeeping').length;
    document.getElementById('stat-maintenance').textContent = staff.filter(u => u.role === 'maintenance').length;
}

function renderStaff(staff) {
    const tbody = document.getElementById('staff-table-body');
    if (!staff.length) {
        tbody.innerHTML = '<tr><td colspan="7" class="text-center py-4 text-muted">No staff members found. Add a staff member to get started.</td></tr>';
        return;
    }
        ...
        return `<tr>
            ...
            <td>
                <div class="d-flex align-items-center gap-2">
                    <div class="avatar-xs">
                        <span class="avatar-title rounded-circle ${color} text-white" style="font-size:11px;">${initials}</span>
                    </div>
            ...
            <td>
                <div class="d-flex gap-1">
                    <button class="btn btn-soft-primary btn-sm" onclick="openEditStaff('${u._id}')" title="Edit">
                        <i class="ri-edit-line"></i>
                    </button>
                    <button class="btn btn-soft-danger btn-sm" onclick="openDeleteStaff('${u._id}')" title="Delete">
...
document.getElementById('filter-role').addEventListener('change', function() {
    ...
    renderStaff(role ? allStaff.filter(u => u.role === role) : allStaff);
});
...
document.getElementById('addStaffBtn').addEventListener('click', async function() {
    ...
    const name = document.getElementById('add-staffName').value.trim();
    const email = document.getElementById('add-staffEmail').value.trim();
    const phone = document.getElementById('add-staffPhone').value.trim();
    const role = document.getElementById('add-staffRole').value;
    const password = document.getElementById('add-staffPassword').value;
    ...
    try {
        ...
        if (res.ok) {
            ...
            document.getElementById('add-staffEmail').value = '';
            document.getElementById('add-staffPhone').value = '';
            document.getElementById('add-staffRole').value = '';
            document.getElementById('add-staffPassword').value = '';
            loadStaff();
        } else {
            errEl.textContent = data.message || 'Error adding staff.';
            errEl.classList.remove('d-none');
        }
    } catch(err) {
...
function openEditStaff(id) {
    const u = allStaff.find(u => u._id === id);
    if (!u) return;
    document.getElementById('edit-staffId').value = id;
    document.getElementById('edit-staffName').value = u.name;
    document.getElementById('edit-staffPhone').value = u.phone || '';
    document.getElementById('edit-staffRole').value = u.role;
    new bootstrap.Modal(document.getElementById('editStaffModal')).show();
}

// Save Edit
document.getElementById('editStaffBtn').addEventListener('click', async function() {
    const btn = this;
    ...
    try {
        const res = await fetch(window.API_URL + '/auth/users/' + id, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + localStorage.getItem('token') },
            body: JSON.stringify({
                name: document.getElementById('edit-staffName').value,
                phone: document.getElementById('edit-staffPhone').value,
                role: document.getElementById('edit-staffRole').value
            })
        });
        if (res.ok) {
            ...
            const data = await res.json();
            errEl.textContent = data.message || 'Error updating staff.';
            errEl.classList.remove('d-none');
        }
    } catch(err) {
        errEl.textContent = 'Server error.';
...
function openDeleteStaff(id) {
    document.getElementById('delete-staffId').value = id;
    new bootstrap.Modal(document.getElementById('deleteStaffModal')).show();
}

document.getElementById('confirmDeleteStaffBtn').addEventListener('click', async function() {
    const btn = this;
    const id = document.getElementById('delete-staffId').value;
