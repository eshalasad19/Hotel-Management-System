                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Registered Users (Guests)</h4>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-medium text-muted mb-1 fs-12">Total Users</p>
                                            <h4 class="mb-0 fw-semibold" id="stat-total-users">0</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-medium text-muted mb-1 fs-12">Guests</p>
                                            <h4 class="mb-0 fw-semibold" id="stat-guests">0</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-medium text-muted mb-1 fs-12">Walk-in Guests</p>
                                            <h4 class="mb-0 fw-semibold" id="stat-walkin">0</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h5 class="card-title mb-0 flex-grow-1">All Registered Users</h5>
                            <input type="text" class="form-control form-control-sm w-auto" id="search-users" placeholder="Search by name or email...">
                        </div>
                        <div class="card-body">
...
async function loadUsers() {
    try {
        ...
        // Sirf guests dikhao — staff alag page pe hai
        allUsers = data.filter(u => u.role === 'guest');
...
function updateStats(allData) {
    const guests = allData.filter(u => u.role === 'guest');
    const walkin = guests.filter(u => u.email && u.email.includes('@walkin.hotel'));
    document.getElementById('stat-total-users').textContent = guests.length;
    document.getElementById('stat-guests').textContent = guests.filter(u => !u.email?.includes('@walkin.hotel')).length;
    document.getElementById('stat-walkin').textContent = walkin.length;
}
            ...
            <td>
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        ...
                        ${isWalkin ? '<small class="text-muted">Walk-in Guest</small>' : ''}
                    </div>
                </div>
            </td>
            <td>${isWalkin ? '<span class="text-muted">—</span>' : u.email}</td>
            <td>${u.phone || '—'}</td>
            <td><span class="badge bg-info-subtle text-info">Guest</span></td>
            <td><small class="text-muted">${date}</small></td>
            <td>
                <button class="btn btn-soft-danger btn-sm" onclick="openDeleteUser('${u._id}')">
