      ...
      <div className="container">
        <div className="mx-auto text-center mb-5">
          ...
          <h2 className="heading-font-family text-13 fw-600 lh-sm wow fadeInUp" data-wow-delay=".2s">
            What Our <span className="text-primary">Client Says <br className="d-none d-md-block" />About</span> Hotel The
            Mist
          </h2>
        </div>
              ...
              <div key={item.name} className="swiper-slide">
                <div className="bg-white rounded-5 p-5">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    <img className="rounded-circle w-auto" src={userAsset(item.image)} alt={item.name} />
                    <div>
                      <h3 className="text-4 fw-600 mb-1">{item.name}</h3>
                      <div className="text-3 fw-500 text-body-tertiary">{item.location}</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="fw-500 text-center mt-4 wow fadeInUp">
          View On{' '}
          <a href="https://www.tripadvisor.com/" className="fw-600 link-primary link-offset-2 link-underline-opacity-100 link-underline-opacity-0-hover">
            Tripadvisor
          </a>
        </div>
      </div>
