...
import { NavLink } from 'react-router-dom'
  ...
  const [hotelInfo, setHotelInfo] = React.useState(() => {
    try { return JSON.parse(localStorage.getItem('hotel_info')) || {}; }
    catch { return {}; }
  });
          ...
          <div className="container">
            <div className="row gy-4">
              ...
              <div className="col-sm-7 col-md-6 col-lg-4">
                ...
                <p className="text-3">{hotelInfo.description || 'Welcome to Luxury Stay Hotel — a luxurious haven nestled in the heart of the city.'}</p>
              </div>
  ...
  <div className="text-3 lh-lg">{hotelInfo.address || '423 W 9th St, Los Angeles, CA 90014, United States'}</div>
</div>
                <a href="tel:+0604445346" className="d-flex align-items-center gap-3 mb-2 link-primary link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover">
                  ...
                  <div className="text-4 fw-500">{hotelInfo.phone || '+92 300 0000000'}</div>
                </a>
                <a href={`mailto:${hotelInfo.email || 'info@theluxurystay.com'}`} className="d-flex align-items-center gap-3 link-light link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover">
                  <span className="text-5" style={{ color: "#c9a96e", flexShrink: 0 }}><i className="fa-solid fa-envelope"></i></span>
                  <div className="text-4 fw-500">{hotelInfo.email || 'info@theluxurystay.com'}</div>
                </a>
                <div className="mt-4">
            ...
            <div className="container">
              <div className="row gy-3">
                <div className="col-lg">
                  <p className="text-3 text-center mb-2">Copyright &copy; 2026 <a className="fw-500 link-primary" href="#">{hotelInfo.hotelName || 'The Luxury Stay'}</a>. All Rights Reserved.</p>
